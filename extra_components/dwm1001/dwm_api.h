 ...
 */
int dwm_pos_set_xyz(uint8_t * spidev, int32_t* p_x, int32_t* p_y, int32_t* p_z);//todo
 ...
 * @return Error code
 */
int dwm_pos_get(uint8_t * spidev, dwm_pos_t* pos);
 ...
 * @return Error code
 */
int dwm_upd_rate_set(uint8_t * spidev, uint16_t ur, uint16_t urs);
 ...
 * @return Error code
 */
int dwm_upd_rate_get(uint8_t * spidev, uint16_t *ur, uint16_t *urs);
 ...
 * @return Error code
 */
int dwm_baddr_set(uint8_t * spidev, dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_baddr_get(uint8_t * spidev, dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_gpio_value_get(uint8_t * spidev, dwm_gpio_idx_t idx, bool* value);
 ...
 */
int dwm_panid_set(uint8_t * spidev, uint16_t panid);
 ...
 * @retval DWM_ERR_INVAL_ADDR null pointer supplied
 */
int dwm_panid_get(uint8_t * spidev, uint16_t *p_panid);
 ...
 */
int dwm_uwb_preamble_code_set(uint8_t * spidev, dwm_uwb_preamble_code_t code); // todo
 ...
 * @retval DWM_ERR_INTERNAL DWM internal error
 */
int dwm_uwb_preamble_code_get(uint8_t * spidev, dwm_uwb_preamble_code_t *p_code); // todo
