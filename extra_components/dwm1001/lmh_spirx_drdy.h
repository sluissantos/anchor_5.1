 ...
 * @return Error code
 */
int  LMH_SPIRX_DRDY_WaitForRx(uint8_t * spidev, uint8_t* data, uint16_t* length, uint16_t exp_length);

int LMH_SPIRX_XFER_DRDY_WaitForRx(uint8_t * spidev, uint8_t *data, uint16_t *length, uint16_t exp_length);
