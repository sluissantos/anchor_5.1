...
/**
* @brief Função de callback para definição de IP na rede WIFI
* 
* @param handler_args dados do usuário registrado nesse evento
* @param base tipo de evento base para o gerenciador (sempre WIFI Base para esse componente)
* @param event_id id do evento recebido
* @param event_data os dados do evento
*/
